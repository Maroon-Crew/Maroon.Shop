...
namespace Maroon.Shop.Api.Client.Models
{
    ...
    public partial class UpdateBasketItemRequest : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Maroon.Shop.Api.Client.Models.UpdateBasketItemRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Maroon.Shop.Api.Client.Models.UpdateBasketItemRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Maroon.Shop.Api.Client.Models.UpdateBasketItemRequest();
        }
        /// <summary>
