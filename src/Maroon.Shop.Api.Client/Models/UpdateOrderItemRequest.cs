...
namespace Maroon.Shop.Api.Client.Models
{
    ...
    public partial class UpdateOrderItemRequest : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Maroon.Shop.Api.Client.Models.UpdateOrderItemRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Maroon.Shop.Api.Client.Models.UpdateOrderItemRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Maroon.Shop.Api.Client.Models.UpdateOrderItemRequest();
        }
        /// <summary>
