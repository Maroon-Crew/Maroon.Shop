...
namespace Maroon.Shop.Api.Client.Api.OrderItem
{
    ...
    public partial class OrderItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Maroon.Shop.Api.Client.Api.OrderItem.Item.WithOrderItemItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("OrderItemId", position);
                return new global::Maroon.Shop.Api.Client.Api.OrderItem.Item.WithOrderItemItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class OrderItemRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Maroon.Shop.Api.Client.Api.OrderItem.OrderItemRequestBuilder.OrderItemRequestBuilderGetQueryParameters>
        {
        }
    }
}
